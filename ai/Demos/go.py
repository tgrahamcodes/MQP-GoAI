...
if __name__ == "__main__":
    ...
    gu.print_welcome("Go", ai_type)
    
    # Print empty board at start
    gu.print_go_board(np.zeros((Board_SIZE, Board_SIZE)), Board_SIZE)
